...
.. csv-table::
    ...
    **chain**; ; ;
    ...
    harvestingMosaicId; 0x5F54'6334'54C3'685B; MosaicId; Mosaic id used to provide harvesting ability.
    ...
    totalChainImportance; 8'998'999'998'000'000; Importance; Total whole importance units available in the network.
...
.. csv-table::
    ...
    **localnode**; ; ;
    host; node; string; Node host (leave empty to auto-detect IP).
