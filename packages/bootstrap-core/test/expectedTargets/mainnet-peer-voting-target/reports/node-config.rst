...
.. csv-table::
    ...
    **harvesting**; ; ;
    ...
    beneficiaryAddress; NCR4O62LYKKDYHXW5AAOKD2IT5Q4TC2U4SUVEYY; Address; Address of the account receiving part of the harvested fee.
...
.. csv-table::
    ...
    **localnode**; ; ;
    host; myRegularNode.host.com; string; Node host (leave empty to auto-detect IP).
    friendlyName; myRegularNode; string; Node friendly name (leave empty to use address).
