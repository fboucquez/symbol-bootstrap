...
- **New Service:** `Walelt`. Bootstrap private network starts a Wallet service in [http://localhost:80/](http://localhost:90/) when using `--assembly full`. . **Warning:** This wallet service is for demonstration proposes.
- **New Service:** `Explorer`. Bootstrap private network starts a Faucet service in [http://localhost:90/](http://localhost:80/) when using `--assembly full`. 
- **New Service:** `Faucet`. Bootstrap private network starts an Explorer service in [http://localhost:100/](http://localhost:100/) when using `--assembly full`. 
