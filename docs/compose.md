...
_See code: [src/commands/compose.ts](https://github.com/nemtech/symbol-bootstrap/blob/v0.3.2-alpha-202101111534-alpha-202101111918/src/commands/compose.ts)_
