...
const customPreset: CustomPreset = {
    ...
    knownPeers: [
        {
            publicKey: '3BE809A65B98E8AF7E5835A9C12F90B29BEDFFFF97E11C1160D8136F15B66AD1',
            endpoint: {
                host: 'test-beacon-101.testnet',
                port: 7900,
            },
            metadata: {
                name: 'test-beacon-101',
                roles: 'Peer,Voting',
            },
        },
        {
            publicKey: 'A33EF3ED8CFBF16C2C3468FCAEE78B36F6F0E737820CE9F48D349309515316F8',
            endpoint: {
                host: 'test-beacon-401.testnet',
                port: 7900,
            },
            metadata: {
                name: 'test-beacon-401',
                roles: 'Peer',
            },
        },
        {
            publicKey: '41F38D9C02F7D3D460A4CB0311E3D6E67CB063351434A6A00BB6F7AE64CD4FD7',
            endpoint: {
                host: 'test-dual-601.testnet',
                port: 7900,
            },
            metadata: {
                name: 'test-dual-601',
...
const newNetworkType = NetworkType.TEST_NET;
...
describe('BootstrapService config', () => {
    ...
    after(async () => {
        ...
        await zipUtils.zip('target/targets.zip', [
            {
                from: 'target/targets',
                to: 'expectedTargets',
                directory: true,
