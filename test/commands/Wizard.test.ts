...
import Wizard, { BootstrapPresetContent, Network } from '../../src/commands/wizard';
import { PrivateKeySecurityMode } from '../../src/model';
import { BootstrapUtils, RewardProgram } from '../../src/service';
...
describe('Wizard', () => {
    ...
    it('Generate private keys', async () => {
        ...
        const customPresetFile = `${testFolder}/wizard-custom.preset`;
        ...
        const expectedCustomPreset: BootstrapPresetContent = {
            assembly: 'dual',
            nodes: [
                {
    ...
    it('Generate use seed keys', async () => {
        // assembly
        StdUtils.in([
            StdUtils.keys.down,
            StdUtils.keys.down,
